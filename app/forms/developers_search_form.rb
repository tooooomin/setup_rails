...
class DevelopersSearchForm
  ...
  PARAMS = %i[programming_language_id language_id].freeze

  def search
    query = Developer.includes(:developer_programming_languages, :programming_languages, :developer_languages, :languages)
